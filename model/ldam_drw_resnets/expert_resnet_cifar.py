...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_experts, num_classes=10, reduce_dimension=False, layer2_output_dim=None, layer3_output_dim=None, share_layer2=False, share_layer3=False, use_norm=False, returns_feat=True, use_experts=None, s=30, **kwargs):
